...
public interface UsuarioRepository extends JpaRepository<Usuario, Integer> {
	 ...
	 * ) int updateEstado(@Param("estado") int idEstado, @Param("idUsuario") int
	 * id);
	 * 
	 ...
	 * ) boolean login(@Param("username") String username, @Param("password") String
	 * password);
	 * 
	 * @Query("SELECT u FROM Usuario u WHERE nombre_logeo_usuario=:username AND u.password_usuario = :password"
	 * ) Usuario getUsuarioLogin(@Param("username") String
