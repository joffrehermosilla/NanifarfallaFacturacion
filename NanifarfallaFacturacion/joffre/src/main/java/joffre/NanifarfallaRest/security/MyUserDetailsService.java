	   ...
	   @Autowired
	    ...
	    public UserDetails loadUserByUsername(final String email) throws UsernameNotFoundException {
	        ...
	        try {
	            ...
	            return new org.springframework.security.core.userdetails.User(user.getEmail(), user.getPassword_usuario(), user.isEnabled(), true, true, true, getAuthorities(user.getRoles()));
