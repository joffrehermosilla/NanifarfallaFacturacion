...
import joffre.NanifarfallaRest.repository.auditorias.AuditoriaAreaRepository;

@RestController
@RequestMapping("/apiAuditoriaArea")
public class AuditoriaAreaController {
	private static final Log LOGGER = LogFactory.getLog(AuditoriaAreaController.class);

	@Autowired
	AuditoriaAreaRepository audiareaRepository;
