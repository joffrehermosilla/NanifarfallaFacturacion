...
public class Cliente_tiene_pedido {
	...
	public Estado_clientetienepedido getmEstado_cliente_tiene_pedido() {
		return mEstado_cliente_tiene_pedido;
	}

	public void setmEstado_cliente_tiene_pedido(Estado_clientetienepedido mEstado_cliente_tiene_pedido) {
		this.mEstado_cliente_tiene_pedido = mEstado_cliente_tiene_pedido;
	}

	public Factura_ctienepedido getmFactura_cliente_tiene_pedido() {
		return mFactura_cliente_tiene_pedido;
	}

	public void setmFactura_cliente_tiene_pedido(Factura_ctienepedido mFactura_cliente_tiene_pedido) {
