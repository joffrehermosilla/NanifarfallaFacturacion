...
import joffre.NanifarfallaRest.repository.DeviceMetadataRepository;
...
@Transactional
@SpringBootTest(classes = {NanifarfallaRestApplication.class, TestDbConfig.class, TestIntegrationConfig.class},
...
public class DeviceServiceIntegrationTest {
    ...
    public void init() {
        ...
        userId = (long) user.getCodigo_usuario();
    }
